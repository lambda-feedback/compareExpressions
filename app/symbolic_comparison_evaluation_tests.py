...
class TestEvaluationFunction():
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("1/2+1/5*I", "0.5+0.2*I", "answer=response", True, ["answer=response_TRUE", "answer=response_SAME_SYMBOLS_TRUE", "answer=response_SYNTACTICAL_EQUIVALENCE_FALSE", "answer=response_SAME_FORM_CARTESIAN"], {}),
            ("0.5+0.2*I", "1/2+1/5*I", "answer=response", True, ["answer=response_TRUE", "answer=response_SAME_SYMBOLS_TRUE", "answer=response_SYNTACTICAL_EQUIVALENCE_FALSE", "answer=response_SAME_FORM_CARTESIAN"], {}),
            ...
            ("1/2*e**(1/5*I)", "0.5*e^(0.2*I)", "answer=response", True, ["answer=response_TRUE", "answer=response_SAME_SYMBOLS_TRUE", "answer=response_SYNTACTICAL_EQUIVALENCE_FALSE", "answer=response_SAME_FORM_EXPONENTIAL"], {}),
            ("0.5*e^(0.2*I)", "1/2*e**(1/5*I)", "answer=response", True, ["answer=response_TRUE", "answer=response_SAME_SYMBOLS_TRUE", "answer=response_SYNTACTICAL_EQUIVALENCE_FALSE", "answer=response_SAME_FORM_EXPONENTIAL"], {}),
            ...
            ("2*(cos(2)+I*sin(2))", "2*(cos(2)+I*sin(2))", "answer=response", True, ["answer=response_TRUE", "answer=response_SAME_SYMBOLS_TRUE", "answer=response_SYNTACTICAL_EQUIVALENCE_TRUE", "answer=response_SAME_FORM_POLAR"], {}),
            ("2(cos(2)+Isin(2))", "2*(cos(2)+I*sin(2))", "answer=response", True, ["answer=response_TRUE", "answer=response_SAME_SYMBOLS_TRUE", "answer=response_SYNTACTICAL_EQUIVALENCE_FALSE", "answer=response_SAME_FORM_POLAR"], {}),
            ("2(cos(2)+i*sin(2))", "2*(cos(2)+I*sin(2))", "answer=response", True, ["answer=response_TRUE", "answer=response_SAME_SYMBOLS_TRUE", "answer=response_SYNTACTICAL_EQUIVALENCE_FALSE", "answer=response_SAME_FORM_POLAR"], {"symbols": {"I": {"aliases": ["i","j"], "latex": r"\(i\)"}}}),
            ("1/5*(cos(1/2)+I*sin(1/2))", "0.2*(cos(0.5)+I*sin(0.5))", "answer=response", True, ["answer=response_TRUE", "answer=response_SAME_SYMBOLS_TRUE", "answer=response_SYNTACTICAL_EQUIVALENCE_FALSE", "answer=response_SAME_FORM_POLAR"], {}),
            ("0.2*(cos(0.5)+I*sin(0.5))", "1/5*(cos(1/2)+I*sin(1/2))", "answer=response", True, ["answer=response_TRUE", "answer=response_SAME_SYMBOLS_TRUE", "answer=response_SYNTACTICAL_EQUIVALENCE_FALSE", "answer=response_SAME_FORM_POLAR"], {}),
            ("2e^(2i)", "2*(cos(2)+I*sin(2))", "answer=response", True, ["answer=response_TRUE", "answer=response_SAME_SYMBOLS_TRUE", "answer=response_SYNTACTICAL_EQUIVALENCE_FALSE", "answer=response_SAME_FORM_UNKNOWN"], {"symbols": {"I": {"aliases": ["i","j"], "latex": r"\(i\)"}}}),
        ]
    )
