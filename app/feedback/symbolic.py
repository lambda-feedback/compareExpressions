...
feedback_generators["INTERNAL"] = lambda tag: lambda inputs: {
    ...
    "EXPRESSION_NOT_INEQUALITY": "The response was an expression but was expected to be an inequality.",
    "INEQUALITY_NOT_EXPRESSION": "The response was an inequality but was expected to be an expression.",
