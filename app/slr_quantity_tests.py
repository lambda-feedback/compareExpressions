...
slr_strict_si_syntax_test_cases = [
    ...
    ("10 kilogram/(metre second^2)",
     ...
     "10 kilogram/(metre second^2)",
     r"\frac{\mathrm{kilogram}}{(\mathrm{metre}~\mathrm{second}^{2})}",
     ["RESPONSE_FULL_QUANTITY", "RESPONSE_NUMBER_VALUE"]),
    ("10 kilogram*metre/second**2",
     "10",
     "kilogram*metre/second**2",
     "10 kilogram*metre/second**2",
    ...
    ("10*pi kilogram*metre/second^2",
     ...
     "10*pi kilogram*metre/second^2",
     r"\mathrm{kilogram}\cdot\frac{\mathrm{metre}}{\mathrm{second}^{2}}",
     ["RESPONSE_FULL_QUANTITY", "RESPONSE_EXPR_VALUE"]),
    ("(5.27*pi/sqrt(11) + 5*7)^(4.3)",
     "(5.27*pi/sqrt(11) + 5*7)^(4.3)", None,
     "(5.27*pi/sqrt(11) + 5*7)^(4.3)",
     None,
     ["RESPONSE_NO_UNIT", "RESPONSE_EXPR_VALUE"]),
    ...
    ("10 s/g + 5 gram*second^2 + 7 ms + 5 gram/second^3",
     ...
     ["RESPONSE_FULL_QUANTITY", "RESPONSE_EXPR_VALUE", "REVERTED_UNIT"]),
    ...
    ("pi+metre second+pi",
     ...
     "pi+metre second+pi",
     None,
     ["RESPONSE_EXPR_VALUE", "RESPONSE_NO_UNIT", "REVERTED_UNIT"]),
    ("1/s^2",
     None,
     "1/s^2",
     "1/second^2",
     r"\frac{1}{\mathrm{second}^{2}}",
     ["RESPONSE_NO_VALUE", "HAS_UNIT"]),
    ("5/s^2",
     "5/s^2",
     None,
     "5/s^2",
     None,
     ["RESPONSE_NO_UNIT", "RESPONSE_EXPR_VALUE", "REVERTED_UNIT"]),
    ("10 1/s^2",
     "10",
     "1/s^2",
     "10 1/second^2",
